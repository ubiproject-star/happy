...
export default function Matches() {
    ...
    useEffect(() => {
        ...
        const fetchMatches = async () => {
            console.log('UseEffect fired. Fetching matches...');
            try {
                // Robust ID handling
                const myId = tgUser?.id?.toString() || 'user_m_1';
                console.log('Fetching matches for ID:', myId);
                ...
                console.log('Matches loaded:', formattedMatches.length);
    ...
    return (
        <Layout>
            <div className="w-full max-w-full min-h-screen bg-black pb-24 px-2 pt-4 md:pt-10 font-sans overflow-x-hidden box-border">
                {/* Header */}
